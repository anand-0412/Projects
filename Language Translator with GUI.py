...
LanguageChoices = {'Hindi','English','French','German','Spanish',"Tamil","Telegu","Marathi","Korean","Bengali","Russian","Greek","Urdu","Arabic","Chinese","Italian","Thai","Turkish","Hungarian","Japanese","Dutch","Indonesian","Gujarati"}
